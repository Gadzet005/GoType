...
func (_m *Stats) GetUsersTop(params map[string]interface{}) ([]domain.PlayerStats, error) {
	...
	var r0 []domain.PlayerStats
	var r1 error
	if rf, ok := ret.Get(0).(func(map[string]interface{}) ([]domain.PlayerStats, error)); ok {
		return rf(params)
	}
	if rf, ok := ret.Get(0).(func(map[string]interface{}) []domain.PlayerStats); ok {
		r0 = rf(params)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.PlayerStats)
